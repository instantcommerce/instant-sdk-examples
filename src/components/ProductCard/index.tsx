  ...
  return (
    ...
    >
      ...
      {!!pretitleText && (
        <Paragraph
          size="sm"
          className={cx('product-card__pretitle text-theme-text mb-0.25')}
        >
          {pretitleText}
        </Paragraph>
      )}
      ...
      {!!descriptionText && (
        <Paragraph
          ...
          className={cx(
            'product-card__description text-theme-subtitle mt-0.25 line-clamp-3 break-words'
          )}
        >
          {descriptionText}
        </Paragraph>
      ...
      >
        {!!oldPrice && (
          <Paragraph
            className={cx(
              'product-card__price product-card__price--old text-theme-text mr-1 line-through'
            )}
