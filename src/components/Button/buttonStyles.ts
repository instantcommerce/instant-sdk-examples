...
export const variantStyles = {
  ...
  light:
    "bg-white border-gray-300 text-gray-700 hover:bg-primary-50 focus:shadow-[0px_0px_0px_4px_var(--color-primary-100)] disabled:bg-gray-200 disabled:border-gray-200",
